	...
	<div class="thb-popup-box">
		...
		<figure>
			...
			<div class="thb-import-loading">
				...
				<div class="thb-loading-text"><?php esc_html_e( 'Page will refresh after the import is done.', 'overline' ); ?></div>
			</div>
		</figure>
		<h3><?php esc_html_e( 'Import Content', 'overline' ); ?></h3>
		<p><?php esc_html_e( 'You can select import data type you want.', 'overline' ); ?></p>
		<form action="" method="post">
			<div class="thb-check-line">
				<div>
					<div>
						<input type="checkbox" name="ty-contents" id="ty-contents" class="child-opened thb-checked" checked>
						<label for="ty-contents"><?php esc_html_e( 'Contents', 'overline' ); ?></label>
					</div>
					<div class="child-check done">
						<input type="checkbox" name="ty-contents-media" id="ty-contents-media" class="thb-checked" checked>
						<label for="ty-contents-media"><?php esc_html_e( 'Media Files (Thumbnail images, etc.)', 'overline' ); ?></label>
					</div>
				</div>
				<div>
					<input type="checkbox" name="ty-customizer" id="ty-customizer" class="thb-checked" checked>
					<label for="ty-customizer"><?php esc_html_e( 'Theme Options', 'overline' ); ?></label>
				</div>
				<div>
					<input type="checkbox" name="ty-widgets" id="ty-widgets" class="thb-checked" checked>
					<label for="ty-widgets"><?php esc_html_e( 'Widgets', 'overline' ); ?></label>
				</div>
			</div>
			<button type="submit" class="button button-primary"><?php esc_html_e( 'Import Selected', 'overline' ); ?></button>
		</form>
	</div>
</main>
