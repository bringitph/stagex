...
<table class="widefat" cellspacing="0">
	<thead>
		<thead>
			<tr>
				<td><?php esc_html_e( 'Requirements', 'overline' ); ?></td>
				<td></td>
			</tr>
		</thead>
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			<tr>
				<td>
					<?php esc_html_e( 'Server Memory Limit', 'overline' ); ?>:
				</td>
				<td>
					<?php
					...
					<?php } else { ?>
						<mark class="<?php echo esc_attr( $mark ); ?>">
								...
								<?php esc_html_e( 'The recommended value is 256M.', 'overline' ); ?>
						</mark>
					<?php } ?>
				</td>
			</tr>
			<tr>
				<td><?php esc_html_e( 'PHP Version:', 'overline' ); ?></td>
				<td>
					<?php
					if ( function_exists( 'phpversion' ) ) {
						...
						<?php } else { ?>
							<mark class="<?php echo esc_attr( $mark ); ?>">
									...
									<?php wp_kses_post( 'Required PHP Version is at least 5.6. WordPress <a href="https://wordpress.org/about/requirements/" target="_blank">recommends using at least PHP 7.0.</a> ', 'overline' ); ?>
							</mark>
						<?php } ?>
					<?php	} ?>
				</td>
			...
			<tr>
				<td><?php esc_html_e( 'PHP Time Limit', 'overline' ); ?>:</td>
				<td>
					<?php
					...
					<?php } else { ?>
						<mark class="<?php echo esc_attr( $mark ); ?>">
								...
								<?php esc_html_e( 'The recommended value is 180.', 'overline' ); ?>
						</mark>
					<?php } ?>
				</td>
			</tr>
		<?php endif; ?>
		<tr>
			<td><?php esc_html_e( 'Max Upload Size', 'overline' ); ?>:</td>
			<td>
				<?php
				...
				<?php } else { ?>
					<mark class="<?php echo esc_attr( $mark ); ?>">
							...
							<?php esc_html_e( 'The recommended value is 12M.', 'overline' ); ?>
					</mark>
				<?php } ?>
			</td>
		</tr>
		...
		$posting['fsockopen_curl']['help'] = '<a href="#" class="help_tip" data-tip="' . esc_attr__( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'overline' ) . '">[?]</a>';
		...
		// WP Remote Get Check.
		$posting['wp_remote_get']['name'] = esc_html__( 'Remote Get', 'overline' );
		...
		?>
		<tr>
			<td><?php esc_html_e( 'XML Reader', 'overline' ); ?>:</td>
			<td>
				<?php
				...
				<?php if ( 'yes' === $mark ) { ?>
					<mark class="<?php echo esc_attr( $mark ); ?>">
							<span class="dashicons dashicons-yes"></span> <?php esc_html_e( 'Installed', 'overline' ); ?>
					</mark>
				<?php } else { ?>
					<mark class="<?php echo esc_attr( $mark ); ?>">
							<span class="dashicons dashicons-warning"></span>
							<?php esc_html_e( 'Please install XMLReader extension for your PHP.', 'overline' ); ?>
					</mark>
				<?php } ?>
			</td>
		</tr>
