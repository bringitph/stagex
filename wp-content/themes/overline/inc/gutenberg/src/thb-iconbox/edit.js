...
export class Edit extends Component {
  ...
  render(){
    ...
    const {
		...
		const classes = [ 'overline', 'thb-iconbox', self.props.className, alignment ];
    ...
    return [
        ...
        <Fragment>
          ...
          >
	                ...
	                placeholder={ __( 'Title', 'overline' ) } // Display this text before any content has been added by the user
	            	/>
								<RichText
	                tagName="p"
	                ...
	                placeholder={ __( 'Subtitle', 'overline' ) } // Display this text before any content has been added by the user
	            	/>
							</div>
						</div>
          </div>
