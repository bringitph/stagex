		...
		wp_localize_script(
			...
			array(
				...
				'l10n'     => array(
					...
					'of'               => esc_html__( '%curr% of %total%', 'overline' ),
					'just_of'          => esc_html__( 'of', 'overline' ),
					'loading'          => esc_html__( 'Loading', 'overline' ),
					'lightbox_loading' => esc_html__( 'Loading...', 'overline' ),
					'nomore'           => esc_html__( 'No More Posts', 'overline' ),
					'nomore_products'  => esc_html__( 'All Products Loaded', 'overline' ),
					'loadmore'         => esc_html__( 'Load More', 'overline' ),
					'adding_to_cart'   => esc_html__( 'Adding to Cart', 'overline' ),
					'added_to_cart'    => esc_html__( 'Added To Cart', 'overline' ),
					'has_been_added'   => esc_html__( 'has been added to your cart.', 'overline' ),
					'no_results'       => esc_html__( 'No Results Found', 'overline' ),
					'results_found'    => esc_html__( 'Results Found', 'overline' ),
					'results_all'      => esc_html__( 'View All Results', 'overline' ),
					'prev'             => esc_html__( 'Prev', 'overline' ),
					'next'             => esc_html__( 'Next', 'overline' ),
				),
				'nonce'    => array(
