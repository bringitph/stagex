...
<div class="small-12 medium-6 columns">
	<div <?php post_class( $classes ); ?>>
		<?php if ( has_post_thumbnail() ) { ?>
			<figure class="post-gallery">
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
					<?php the_post_thumbnail( 'overline-rectangle-x2' ); ?>
				</a>
				<?php if ( $thb_cat ) { ?>
		...
		<div class="post-inner-content">
			...
			<?php } ?>
			<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="thb-read-more"><?php esc_html_e( 'Read More', 'overline' ); ?> <?php get_template_part( 'assets/img/svg/next_arrow.svg' ); ?></a>
		</div>
	</div>
</div>
