...
class WC_Xendit_CC extends WC_Payment_Gateway_CC
{
     ...
     * @var string
     */
    public $default_description = 'Pay with your credit card via Xendit.';
    ...
    public function payment_scripts()
    {
        ...
        $cc_settings = $this->get_cc_settings();
        $xendit_params['can_use_dynamic_3ds'] = $cc_settings['can_use_dynamic_3ds'] ? 1 : 0;
    ...
    private function process_payment_via_xendit_invoice(WC_Order $order)
    {
        ...
        // Set payment pending
        $order->update_status('pending', __('Awaiting Xendit payment', 'woocommerce-gateway-xendit'));
