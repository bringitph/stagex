...
class WC_Xendit_Invoice extends WC_Payment_Gateway
{
    ...
    public function admin_options()
    {
        ...
        if (empty($this->oauth_data)) {
            echo "<a href='".$this->oauth_link."' class='components-button is-primary' target='_blank'>Connect to Xendit</a>";
        } else {
    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'invoice_expire_duration' => array(
                'title' => __('Invoice Expire Time :', 'xendit'),
                'class' => 'form-control xendit-xenplatform',
                'type' => 'text',
                'default' => __(1, 'xendit'),
                'placeholder' => 'e.g. 30'
            ...
            'invoice_expire_unit' => array(
                ...
                'class' => 'form-control xendit-xenplatform',
                'options' => array(
                    'MINUTES' => __('Minutes', 'xendit'),
                    'HOURS' => __('Hours', 'xendit'),
                    'DAYS' => __('Days', 'xendit'),
                ),
            ),
        );
